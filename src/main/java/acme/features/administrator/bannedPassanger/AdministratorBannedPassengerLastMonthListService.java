...
@GuiService
public class AdministratorBannedPassengerLastMonthListService extends AbstractGuiService<Administrator, BannedPassenger> {
	...
	@Override
	public void load() {
		Collection<BannedPassenger> bp = this.repository.findAllLastMonthBannedPassanger(MomentHelper.deltaFromCurrentMoment(-30, ChronoUnit.DAYS));
