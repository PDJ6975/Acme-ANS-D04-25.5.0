...
@GuiService
public class AdministratorBannedPassengerCurrentListService extends AbstractGuiService<Administrator, BannedPassenger> {
	...
	@Override
	public void load() {
		Collection<BannedPassenger> bp = this.repository.findAllCurrentBannedPassanger(MomentHelper.getCurrentMoment());
