...
<acme:list>
    ...
    <acme:list-column code="customer.booking.list.label.creditCardNibble" path="creditCardNibble"/>
    <acme:list-payload path="payload"/>
</acme:list>

<acme:button code="customer.booking.list.button.create" action="/customer/booking/create?masterId=${masterId}"/>
