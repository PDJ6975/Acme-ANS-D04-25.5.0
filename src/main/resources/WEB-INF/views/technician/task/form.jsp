...
<acme:form>
  <acme:input-select
    code="technician.task.form.label.type"
    path="type"
    choices="${types}"
    readonly="${!draftMode}"
  />
  <acme:input-textarea
    code="technician.task.form.label.description"
    path="description"
    readonly="${!draftMode}"
  />
  <acme:input-integer
    code="technician.task.form.label.priority"
    path="priority"
    readonly="${!draftMode}"
  />
  <acme:input-double
    code="technician.task.form.label.estimatedDuration"
  ...
  <jstl:choose>
    ...
    <jstl:when test="${_command == 'create'}">
      <acme:submit code="technician.task.form.button.create"
                   action="/technician/task/create?maintenanceRecordId=${maintenanceRecordId}"/>
    </jstl:when>
  </jstl:choose>
</acme:form>
